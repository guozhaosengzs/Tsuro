 ...
 *****************************************************************************
   ...
   DESCRIPTION:  An implementation of the game Tsuro.

   Warning:      When running on macOS environment, the double click would not
                 register, hence suspend the program at game-pre phase.
    ...
    def __init__(self, win):
        ...
        with open('matches.txt') as file:
            for line in file:
                ...
                self._coord_list.append(clean_list)

        # Adding background image
        self._bkg = Image(
            self._win, 'images/bkg.jpg', WIN_WIDTH, WIN_HEIGHT, (750, 400))
        ...
        self._board = Image(
            self._win, 'images/board.jpg', BOARD_LEN, BOARD_LEN, self._board_ctr)
...
class Tile(EventHandler):
    ...
    def __init__(self, win, game, number, coord):
        ...
        self._image_loc = "images/" + str(self._id_n) + ".jpg"
    ...
    def handle_mouse_press(self, event):
        ...
        if button == "Left Mouse Button":
            if not self._clicked:
                ...
                self._frame.set_border_color('royalblue')
...
class Dragon:
    ...
    def __init__(self, win, game):
        ...
        self._game = game
        self._status = "pile"
        self._tile = Image(self._win, "images/dragon.jpg", 100, 100, (-250, -250))
